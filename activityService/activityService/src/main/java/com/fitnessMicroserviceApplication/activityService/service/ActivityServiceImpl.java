...
import com.fitnessMicroserviceApplication.activityService.exception.InvalidUserException;
import com.fitnessMicroserviceApplication.activityService.model.Activity;
import com.fitnessMicroserviceApplication.activityService.repo.ActivityRepository;
...
public class ActivityServiceImpl implements ActivityService {
    ...
    public ActivityResponse trackActivity(ActivityRequest request) {
        ...
        try {
            ...
            System.err.println(
                    "Failed to publish activity event: " + e.getMessage()
            );
        }
